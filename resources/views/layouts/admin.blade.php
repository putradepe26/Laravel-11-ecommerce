              ...
              <div class="section-menu-left">
                  <div class="box-logo">
                      <a href="{{route('home.index')}}" id="site-logo-inner">
                          <img class="" id="logo_header_1" alt="" src="{{asset('assets/images/PutraDPOlshop.png')}}"
                              data-light="{{asset('assets/images/PutraDPOlshop.png')}}" data-dark="{{asset('assets/images/PutraDPOlshop.png')}}">
                      </a>
