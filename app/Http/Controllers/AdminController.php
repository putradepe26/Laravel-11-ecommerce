...
class AdminController extends Controller
{
    public function index()
    {
        ...
        $DeliveredAmountM = implode(',', collect($monthlyDatas)->pluck('TotadeliveredAmount')->toArray());
