...
<main class="pt-90">
    ...
    <section class="contact-us container">
      ...
      <div class="about-us__content pb-5 mb-5">
        <p class="mb-5">
          <img loading="lazy" class="w-100 h-auto d-block" src="<?php echo e(asset('assets/images/about/about-1.jpg')); ?>" width="1410"
            height="550" alt="" />
        </p>
        <div class="mw-930">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\laravel-11\resources\views/about.blade.php ENDPATH**/ ?>