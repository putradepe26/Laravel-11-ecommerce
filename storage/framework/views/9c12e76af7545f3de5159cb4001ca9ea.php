    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <a class="tf-button style-1 w208" href="<?php echo e(route('admin.brand.add')); ?>"><i class="icon-plus"></i>Add new</a>
            </div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pname">
                                    <div class="image">
                                        <img src="<?php echo e(asset('uploads/brands')); ?>/<?php echo e($brand->image); ?>" alt="" class="image">
                                    </div>
                                    <div class="name">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\laravel-11\resources\views/admin/brands.blade.php ENDPATH**/ ?>