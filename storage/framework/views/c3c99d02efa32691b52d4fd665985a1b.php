                    ...
                    <div class="product-single__image">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" class="h-auto" src="<?php echo e(asset('uploads/products')); ?>/<?php echo e(trim($gimg)); ?>" width="674" height="674" alt="" />
                                    <a data-fancybox="gallery" href="<?php echo e(asset('uploads/products')); ?>/<?php echo e(trim($gimg)); ?>" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <use href="#icon_zoom" />
                                        </svg>
                                    </a>
                    ...
                    <div class="product-single__thumbnail">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                <?php $__currentLoopData = explode(",",$product->images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="<?php echo e(asset('uploads/products')); ?>/<?php echo e($gimg); ?>" width="104" height="104" alt="" />
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                
                            </div>
                        </div>
            ...
            <div class="col-lg-5">
                ...
                <form name="addtocart-form" method="POST" action="<?php echo e(route('cart.add')); ?>">
                    ...
                    <div class="product-single__addtocart">
                        ...
                        <button type="submit" class="btn btn-primary" data-aside="cartDrawer">Add to Cart</button>
                    </div>
                </form>
                <?php endif; ?>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide product-card">
                        <div class="pc__img-wrapper">
                            <a href="details.php">
                                <img loading="lazy" src="<?php echo e(asset('uploads/products')); ?>/<?php echo e($rproduct->image); ?>" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                <?php if(count(explode(",",$rproduct->images))>0): ?>
                                <img loading="lazy" src="<?php echo e(asset('uploads/products')); ?>/<?php echo e(trim(explode(",",$rproduct->images)[0])); ?>" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                                <?php endif; ?>
                            </a>
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <h6 class="pc__title"><a href="details.php"><?php echo e($rproduct->name); ?></a></h6>
                            <div class="product-card__price d-flex">
                                <span class="money price">$<?php echo e($rproduct->regular_price); ?></span>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\laravel-11\resources\views/details.blade.php ENDPATH**/ ?>